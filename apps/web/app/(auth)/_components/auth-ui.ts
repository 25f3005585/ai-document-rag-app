...
export const authInputClass = 'h-10 px-3 text-sm';

export const authButtonClass = 'h-10 w-full text-sm font-medium';

export const authHelperClass = 'text-muted-foreground text-xs leading-normal';

export const authErrorClass = 'text-destructive mt-1 text-xs';
